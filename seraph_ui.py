def menu():
    ...
    print("[7] Spin up the search engine (diveyez/blackhole) ")
    print("[8] Index/Re-index data folders with Black Hole   ")
    print("[9] Check Status: Black Hole Not Integrated Yet   ")
    print ("[0] Quit")
menu()
